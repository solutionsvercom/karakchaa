    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <CheckCircle2 size={36} style={{ marginBottom: "12px" }} />
          <h3 style={{ margin: "0 0 4px 0", fontSize: "20px", fontWeight: 700 }}>Order Completed!</h3>
          <p style={{ margin: 0, fontSize: "14px", opacity: 0.9 }}>Thank you for your order</p>
        </div>
        ...
        <div style={{
          ...
          <Lightbulb size={20} color="#16A34A" style={{ flexShrink: 0 }} />
